    ...
    <Skeleton>
      ...
      <Container size={'xs'}>
        <Group justify="center">
          ...
          <Anchor c={'#2364d0'} px={4} href={'https://scholar.google.com/citations?user=1E7N-BoAAAAJ'} target={'_blank'}>
          ...
          <Anchor c={'#030b67'} px={4} href={'steamcommunity.com/id/Mhasan502'} target={'_blank'}>
            <FaSteam size={36}/>
          </Anchor>
        </Group>
      </Container>
